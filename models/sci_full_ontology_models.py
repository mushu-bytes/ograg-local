...
class SCIFullCategoryType(str, Enum):
...
class SCIFullCategory(BaseModel):
    type: SCIFullCategoryType = Field(..., alias='@type')
...
class SCIFullOntologyGraph(BaseModel):
    graph: Optional[List[SCIFullCategory]] = Field(default_factory=list, alias="@graph")
